...
document.getElementById("concatenateSomeStrings").onclick = function () {
    ...
    document.getElementById("output").innerHTML = "Good Day Hafiz Osama!!!"; 
...
document.getElementById("login").onclick = function () {
    ...
    if (userName === "hafizOsama" && password === 123) {
...
//     alert("Check button was clicked!");
//     document.getElementById("statement").innerHTML = 'alert("Check button was clicked!");';
//     document.getElementById("output").innerHTML = "Check button was clicked!";


// }

document.getElementById("check").addEventListener("click", function() {
    let x = document.getElementById("heading-h4");
